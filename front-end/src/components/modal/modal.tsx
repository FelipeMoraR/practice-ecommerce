...
const Modal = ({ header, body, isOpen, hideModal }: IModal) => {
    ...
    <>
        ...
        <div className="fixed fade-in z-30 left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-gray-lightest flex flex-col gap-3 size-50  justify-center p-2 outline-4 outline-black-darkest border-t-4 border-l-4 border-gray-lighter">
